...
object BitcoinSBlockApiDemo extends App {
  ...
  def getBlockRaw(blockHash: String): Unit = {
    ...
    block.transactions.foreach { t =>
      ...
      val sumOutputs = t.outputs.map(_.value.toBigDecimal).sum
      println(s"${t.txIdBE.hex} ${sumOutputs.toLong} \t\t $sumInputs \t\t ${sumInputs-sumOutputs}")
    }
  }

  //getBlockRaw("00000000000000000010b5ded3990b193dbc359cb5525a2e95e94491f1dea590")
  getBlockRaw("0000000000000000000faaa00540dc7e23ec9d5069300dd09f827d3c7ff94eb3")
