...
(
  ...
  last2hPeriods: Seq[(String,Long,String,String)],
...
object FeeResult {
  ...
  def fake = FeeResult(
    ...
    155,
    Seq(
      ("8:00-10:00", 150, "0", ""), ("10:00-12:00", 140, "0", ""), ("12:00-14:00", 130, "0", ""), ("14:00-16:00", 140, "0", ""), ("16:00-18:00", 150, "0", ""), ("18:00-20:00", 140, "0", ""),
      ("20:00-22:00", 120, "0", ""), ("22:00-00:00", 110, "0", ""), ("00:00-02:00", 120, "0", ""), ("02:00-04:00", 125, "0", ""), ("04:00-06:00", 135, "0", ""), ("06:00-08:00", 150, "0", "")
    ),
    155,
    0.00027,
    2.47,
